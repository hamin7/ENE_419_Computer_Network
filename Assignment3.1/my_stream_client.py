...
while(True):    
    ...
    if json_data["type"] == 'orderbook':
        ...
        print("ask_price : %s, bid_price : %s, ask_size : %s, bid_size : %s" %(ask_price,bid_price,ask_size,bid_size))
        ...
        print("trade_price : %s, trade_volume : %s, ask_bid : %s \n" %(trade_price,trade_volume,ask_bid))
ws.close()
